...
to make a new directory in lab03-s2-clee: 
```
mkdir ~/labs/lab04-$MYGIT/globins
cd ~/labs/lab04-$MYGIT/globins
muscle -in ~/labs/lab04-$MYGIT/globins/globins.homologs.fas -out ~/labs/lab04-$MYGIT/globins/globins.homologs.al.fas
